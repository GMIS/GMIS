...
public:	
	...
	public:
		...
		CLinker       GetNextLinker(int64 SourceID); //得到SourceID的下一个，用于遍历列表
	...
	protected:
		CABMutex*					     m_pMutex;
		int32                            m_MaxNerveWorkerNum;      //允许最大中枢神经处理线程数目，default=20
	...
	public:
		...
		bool    RequestCreateNewCentralNerveWork(int32 MsgNum,int64 Interval,uint32& Reason); //返回理由 
	};
...
public:
	...
	virtual void  OutputLog(uint32 Flag,const TCHAR* text)=0;
