...
public:
	...
	public:
        ...
        CLogicDialog* CreateNewDialog(int64 SourceID,int64 DialogID,
		...
		void    RegisterEvent(int64 EventID,int64 ClientEventID,ePipeline& ExePipe,ePipeline& LocalAddress,int64 EventInterval, bool bEventOnce,int64 InstinctID,bool bPrivate);
		bool    GetEvent(int64 EventID,CBrainEvent& EventInfo,bool bDelete);
		void    ModifyEvent(int64 EventID,CBrainEvent& EventInfo);
		...
		void    SendMsgToGUI(int64 SourceID,CMsg& Msg);
		void    SendMsgToGUI(CMsg& Msg,int64 ExcludeSourceID);

		int32   GetWebIOWorkerNum();
		CThreadWorker* CreateThreadWorker(int64 ID,System* Parent,int32 Type);
		void    DeleteThreadWorker(int64 ID,int32 Type);
...
//////////////////////////////////////////////////////////////////////////
private:
	static CBrain*                 GMIS_BRAIN_INSTANCE_PTR;
...
//	void			  OutputLog(uint32 Flag,const CMsg& Msg);
...
//////////////////////////////////////////////////////////////////////////
	...
	bool			  CreateSysDialog(int64 SourceID,tstring SourceName,bool bEdit);
	void			  StartSysTask(SysTaskType SysTask,int64 SourceID,ePipeline& Param,tstring TaskName,int64 ClientEventID,bool bOnce);
//////////////////////////////////////////////////////////////////////////
	...
	void			  OnTaskRuntimeInfo(CLogicDialog* Dialog,CMsg& Msg);
	void			  OnTaskRuntimeLogic(CLogicDialog* Dialog,CMsg& Msg);
	void			  OnTaskRuntimeResult(CLogicDialog* Dialog,CMsg& Msg);
	...
	void			  OnRobotStartRequest(CLogicDialog* Dialog,CMsg& Msg);
	void			  OnRobotRequestRuntime(CLogicDialog* Dialog,CMsg& Msg);
	void			  OnRobotExecuteResquest(CLogicDialog* Dialog,CMsg& Msg);
	void			  OnRobotCloseRequest(CLogicDialog* Dialog, CMsg& Msg);
...
////////////////////////////////////////////////////////////////////////// 
	...
	virtual void	  NoitfyDialogState(CLogicDialog* Dialog, ePipeline* NotifyInfo);	
						void OnNotifyWorkMode(CLogicDialog* Dialog, ePipeline* NotifyInfo);
						...
						void OnNotifyInputView(CLogicDialog* Dialog,ePipeline* NotifyInfo);
...
inline  CBrain* GetBrain(){
	return CBrain::GetBrain();
}
