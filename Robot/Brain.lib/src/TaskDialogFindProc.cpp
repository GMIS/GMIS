...
void CTaskDialog::_FindTokenAnd(deque<int64>& DestMeaningList, map<int64,MyDeque>& SrcMeaningList,map<int64,MyDeque>& ResultMeaningList,bool first){
...
void CTaskDialog::_FindTokenOr(deque<int64>& DestMeaningList, map<int64,MyDeque>& SrcMeaningList,map<int64,MyDeque>& ResultMeaningList){
...
void CTaskDialog::_FindTokenNot(deque<int64>& DestMeaningList, map<int64,MyDeque>& SrcMeaningList,map<int64,MyDeque>& ResultMeaningList){
...
void CTaskDialog::_FindMemoryRoom(CLogicThread* Think,map<int64,MyDeque>* DestTokenList, deque<int64>* ResultRoomList){
...
void CTaskDialog::FindFirst(tstring& text,FindTypeExpected FindType/*= FIND_ALL*/){
	m_FindType = FindType;
...
void CTaskDialog::FindContinue(CLogicThread* Think,uint32 Index, ePipeline& SearchResult){	
...
void CTaskDialog::ProcessMeaning(CLogicThread* Think,int64 RoomID,int64 RoomValue,int64 RoomType,FindTypeExpected FindType /*= FIND_ALL*/){
...
void  CTaskDialog::PrintText(CLogicThread* Think,ePipeline& SearchResult,int32 n,int64 RoomID){
	tstring Text;
...
void  CTaskDialog::PrintLogic(CLogicThread* Think,ePipeline& SearchResult,int32 n,int64 RoomID,int64 RoomValue){
	tstring Text ;
...
void  CTaskDialog::PrintObject(CLogicThread* Think,ePipeline& SearchResult,int32 n,int64 RoomID,int64 RoomValue){
...
void  CTaskDialog::OutputFindResult(int8 type, int64 RoomID,int64 RoomValue){
	//避免结果重复之苯方法
/*
