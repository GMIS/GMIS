		...
		try{
			...
			while (m_Alive)
			{
				...
				{		
					...
					m_IdleCount++;
					if (m_IdleCount>LockedData->GetNerveMaxIdleCount()) //��Լ600��������Ϣ�ɴ������˳�
					{
...
void System::CLockedSystemData::Dead(){
	//CLock lk(m_pMutex); IOWork->Dead()����Ҫ����CLockedSystemData����Ƕ������
...
bool  System::CLockedSystemData::RequestCreateNewNerveWork(uint32 MsgNum,int64 Interval,uint32& Reason) //��������
{
	...
	else if (m_NerveWorkingNum == m_NerveWorkList.size()) //ȫ����ռ��
	{			
